...
exports.videogame_create_get = async function (req, res, next) {
	...
	res.render('videogame_create', {
		title: 'Create videogame entry',
...
exports.videogame_update_post = [
	...
	async (req, res, next) => {
		...
		if (!errors.isEmpty()) {
			...
			// Data from form is valid. Update videogame.
			const updatedVideogame = await Videogame.findByIdAndUpdate(req.params.id, videogame, {})
			res.redirect(updatedVideogame.url)
		}
	},
]
